...
public class NewCustomer extends JFrame implements ActionListener{
 ...
 JLabel lblmeter;
    ...
    lblname.setBounds(120,80,100,20);    
    p.add(lblname);
    ...
    lblmeterno.setBounds(120,120,100,20);    
    p.add(lblmeterno);
    ...
    lbladdress.setBounds(120,160,100,20);    
    p.add(lbladdress);
    ...
    lblcity.setBounds(120,200,100,20);    
    p.add(lblcity);
    ...
    lblstate.setBounds(120,240,100,20);    
    p.add(lblstate);
    ...
    lblemail.setBounds(120,280,100,20);    
    p.add(lblemail);
    ...
    lblphone.setBounds(120,320,100,20);    
    p.add(lblphone);
...
public void actionPerformed(ActionEvent ae) {
    if(ae.getSource()== next) {
        ...
        String query2 ="insert into login values('"+meter+"','','x"+name+"','','')";
